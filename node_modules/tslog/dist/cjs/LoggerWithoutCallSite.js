...
class LoggerWithoutCallSite {
    ...
    printPrettyLog(std, logObject) {
        if (this.settings.displayDateTime === true) {
            ...
            std.write(LoggerHelper_1.LoggerHelper.styleString(["gray"], `${nowStr}\t`, this.settings.colorizePrettyLogs));
        }
        ...
        logObject.argumentsArray.forEach((argument) => {
            const typeStr = this.settings.displayTypes === true
                ? LoggerHelper_1.LoggerHelper.styleString(["grey", "bold"], typeof argument + ":", this.settings.colorizePrettyLogs) + " "
                : "";
    ...
    _printPrettyError(std, errorObject, printStackTrace = true) {
        var _a;
        std.write("\n" +
            LoggerHelper_1.LoggerHelper.styleString(["bgRed", "whiteBright", "bold"], ` ${errorObject.name} `, this.settings.colorizePrettyLogs) +

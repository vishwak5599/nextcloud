...
export class LoggerWithoutCallSite {
    ...
    setSettings(settings, parentSettings) {
        ...
        this._mySettings.name = (_a = this._mySettings.name) !== null && _a !== void 0 ? _a : (this._mySettings.setCallerAsLoggerName
            ? (_g = (_d = (_c = (_b = LoggerHelper.getCallSites()) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.getTypeName()) !== null && _d !== void 0 ? _d : (_f = (_e = LoggerHelper.getCallSites()) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.getFunctionName()) !== null && _g !== void 0 ? _g : undefined : undefined);
        ...
        this._maskAnyRegExp =
            ((_h = this.settings.maskAnyRegEx) === null || _h === void 0 ? void 0 : _h.length) > 0
    ...
    _buildLogObject(logLevel, logArguments, exposeStack = true) {
        ...
        const stackFrame = this._callSiteWrapper(relevantCallSites[0]);
        const stackFrameObject = LoggerHelper.toStackFrameObject(stackFrame);
        ...
        if (errorObject.stack.length > 0) {
            ...
            if (exposeErrorCodeFrame && errorCallSite.lineNumber != null) {
                if (errorCallSite.fullFilePath.indexOf("node_modules") < 0) {
                    errorObject.codeFrame = LoggerHelper._getCodeFrame(errorCallSite.fullFilePath, errorCallSite.lineNumber, errorCallSite.columnNumber, this.settings.exposeErrorCodeFrameLinesBeforeAndAfter);
                }
            }
        }
        return errorObject;
    ...
    printPrettyLog(std, logObject) {
        if (this.settings.displayDateTime === true) {
            ...
            std.write(LoggerHelper.styleString(["gray"], `${nowStr}\t`, this.settings.colorizePrettyLogs));
        }
        ...
        logObject.argumentsArray.forEach((argument) => {
            const typeStr = this.settings.displayTypes === true
                ? LoggerHelper.styleString(["grey", "bold"], typeof argument + ":", this.settings.colorizePrettyLogs) + " "
                : "";
    ...
    _printPrettyError(std, errorObject, printStackTrace = true) {
        var _a;
        std.write("\n" +
            LoggerHelper.styleString(["bgRed", "whiteBright", "bold"], ` ${errorObject.name} `, this.settings.colorizePrettyLogs) +
